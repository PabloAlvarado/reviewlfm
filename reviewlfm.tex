...
being forced by a latent function $u(t)$, \mauricio{\textbf{which an example of a physical system that with such a
    model} sorry, I don't get this}. The output
