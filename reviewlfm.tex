...
\subsection{Classes of models considered}
%
\simo{Explain what kind of models in general we consider.}
...
\simo{Show/argue that latent force models are not observable but are detectable. The detectability follows, because the unstable states arising from the latent force model are still stable.}
