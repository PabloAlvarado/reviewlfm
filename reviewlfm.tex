...
\simo{Show that latent force models are not observable but are detectable}
...
\subsection{Linear Quadratic Gaussian Control Problems on LFMs}
%


\subsection{Linear Quadratic Regulation of LFMs}


\subsection{Stabilizabiilty of Controlled LFMs}
