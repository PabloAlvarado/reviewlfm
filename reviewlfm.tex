...
%
\simo{Explain the principles how we approach the problem.}
...
%
\simo{Here we explain that LFMs are always stabilizable provided that the problem without a latent force model is and hence the control problem makes sense. Find a reference for this.}
