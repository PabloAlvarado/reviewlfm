function kern = rbfpKernParamInit(kern)

% RBFPKERNPARAMINIT RBFP kernel parameter initialisation.
% The radial basis function for the Poisson kernel (RBFP) is a strictly two
% input dimension covariance function, in which each of both inputs is
% described by an RBF covariance. It is supposed to be use with the POISSON
...
%
% SEEALSO : poissonKernParamInit.m, kernCreate, kernParamInit
%
...
if kern.inputDimension ~= 2
  error('RBFP kernel only valid for 2-D inputs.')
end

kern.inverseWidthX = 1000;
kern.inverseWidthY = 1000;
