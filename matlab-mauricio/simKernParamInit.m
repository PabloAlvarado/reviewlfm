...
% negative.
% 
% An additional option is to consider the sensitivities as variables and
% not include them in the vector of parameters. With this the only
% parameters would be B and D, which are positive.
%
% FORMAT
